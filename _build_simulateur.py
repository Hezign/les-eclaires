...
/* Hero : retirer la barre + réduire l'espace avant le simulateur */
.simp-hero{border-bottom:none;padding-bottom:24px}
.sim-section{border-top:none}
.sim-card{margin-top:24px}
</style>'''
