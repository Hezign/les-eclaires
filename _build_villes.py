...
CITIES = [
 ...
 dict(slug='nantes', name='Nantes', dept='Loire-Atlantique', code='44', in_dept='en Loire-Atlantique',
   ...
   local="Sixième ville de France, Nantes conjugue un fort dynamisme économique et un habitat pavillonnaire très répandu dans la métropole, idéal pour installer une borne à domicile. Nantes Métropole mène une politique volontariste de mobilité propre, avec une zone à faibles émissions en déploiement et un réseau de bornes publiques en expansion ; la recharge à domicile reste toutefois la solution la plus simple et la plus économique pour les maisons d'Orvault, Rezé, Vertou ou Carquefou. Le réseau d'installateurs certifiés IRVE de Loire-Atlantique est dense et couvre toute l'agglomération nantaise avec des délais courts, de l'Île de Nantes aux communes du vignoble.",
 ...
 dict(slug='toulouse', name='Toulouse', dept='Haute-Garonne', code='31', in_dept='en Haute-Garonne',
   ...
   local="Quatrième ville de France et métropole en forte croissance démographique, Toulouse compte de nombreux quartiers pavillonnaires (Tournefeuille, Balma, Saint-Orens) particulièrement propices à l'installation d'une borne individuelle, ainsi qu'un tissu de copropriétés récentes. Toulouse Métropole soutient la mobilité électrique et déploie une zone à faibles émissions qui accélère le passage à l'électrique. Le réseau d'installateurs certifiés IRVE de Haute-Garonne est étoffé et permet des interventions rapides sur toute l'agglomération, de la ville rose à Blagnac et Colomiers.",
 ...
 dict(slug='rennes', name='Rennes', dept='Ille-et-Vilaine', code='35', in_dept='en Ille-et-Vilaine',
   ...
   local="Capitale de la Bretagne, Rennes conjugue un fort dynamisme économique et universitaire avec un habitat mêlant pavillonnaire et copropriétés récentes dans toute Rennes Métropole. La collectivité mène une politique active de mobilité propre, avec un réseau de bornes publiques en expansion ; la recharge à domicile reste toutefois la solution la plus simple et la plus économique pour les maisons de Cesson-Sévigné, Bruz, Saint-Grégoire ou Pacé. Le réseau d'installateurs certifiés IRVE d'Ille-et-Vilaine est dense et couvre l'ensemble de l'agglomération rennaise avec des délais courts.",
 ...
 dict(slug='la-rochelle', name='La Rochelle', dept='Charente-Maritime', code='17', in_dept='en Charente-Maritime',
   ...
   local="Ville littorale pionnière du développement durable, La Rochelle porte de longue date une ambition environnementale qui se traduit dans ses politiques de mobilité et son habitat pavillonnaire très répandu autour de l'agglomération. Le réseau de bornes publiques s'y développe régulièrement ; la recharge à domicile demeure cependant la solution la plus simple et la plus économique pour les maisons d'Aytré, Lagord, Périgny ou Châtelaillon-Plage. Le réseau d'installateurs certifiés IRVE de Charente-Maritime couvre bien le bassin rochelais, avec des délais d'intervention maîtrisés.",
 ...
 dict(slug='chambery', name='Chambéry', dept='Savoie', code='73', in_dept='en Savoie',
   ...
   local="Aux portes des Alpes, Chambéry et l'agglomération de Grand Chambéry conjuguent un habitat individuel important, dans la cluse comme dans les communes du tour du lac du Bourget, et une réelle sensibilité à la mobilité propre. La topographie savoyarde et les trajets fréquents vers les stations rendent le choix de la puissance de borne (7,4 ou 11 kW) et d'une recharge programmée en heures creuses particulièrement pertinents. Les installateurs certifiés IRVE de Savoie connaissent bien les contraintes locales, du logement de centre-ville aux résidences en coteau, et interviennent rapidement sur l'ensemble du bassin chambérien.",
 ...
 dict(slug='valence', name='Valence', dept='Drôme', code='26', in_dept='dans la Drôme',
   ...
   local="Située sur l'axe rhodanien, Valence bénéficie d'une position stratégique entre Lyon et la Provence et d'un habitat pavillonnaire largement dominant sur ses coteaux. L'agglomération développe son offre de bornes publiques ; la recharge à domicile reste néanmoins la solution la plus simple et la plus économique pour les maisons de Bourg-lès-Valence, Portes-lès-Valence, Guilherand-Granges ou Saint-Péray. Le réseau d'installateurs certifiés IRVE de la Drôme est bien implanté et couvre l'ensemble du bassin valentinois avec des délais courts.",
 ...
 dict(slug='grenoble', name='Grenoble', dept='Isère', code='38', in_dept='en Isère',
   ...
   local="Ville alpine engagée de longue date dans l'écologie, Grenoble et la métropole Grenoble-Alpes portent une politique volontariste de mobilité propre, avec une zone à faibles émissions et un réseau de bornes publiques en expansion. L'habitat y alterne copropriétés urbaines et pavillonnaire en périphérie ; la recharge à domicile reste la solution la plus simple et la plus économique pour les maisons de Saint-Martin-d'Hères, Échirolles, Meylan ou Seyssinet-Pariset. Le réseau d'installateurs certifiés IRVE de l'Isère est dense et couvre toute l'agglomération grenobloise avec des délais courts.",
 ...
 dict(slug='angers', name='Angers', dept='Maine-et-Loire', code='49', in_dept='en Maine-et-Loire',
   ...
   local="Ville d'art et d'histoire réputée pour sa qualité de vie, Angers conjugue dynamisme économique et habitat pavillonnaire très répandu dans toute l'agglomération angevine. Angers Loire Métropole développe son réseau de bornes publiques ; la recharge à domicile reste cependant la solution la plus simple et la plus économique pour les maisons d'Avrillé, Trélazé, Les Ponts-de-Cé ou Beaucouzé. Le réseau d'installateurs certifiés IRVE du Maine-et-Loire est bien implanté et couvre l'ensemble du bassin angevin avec des délais courts.",
 ...
 dict(slug='poitiers', name='Poitiers', dept='Vienne', code='86', in_dept='dans la Vienne',
   ...
   local="Ville résidentielle et étudiante, Poitiers présente un habitat individuel très répandu, dans la commune comme dans les bourgs de Grand Poitiers (Buxerolles, Saint-Benoît, Migné-Auxances), favorable à la recharge à domicile. La collectivité accompagne la transition vers la mobilité propre et le réseau de bornes publiques s'étoffe, mais installer sa propre borne reste la solution la plus économique au quotidien. Les installateurs certifiés IRVE de la Vienne couvrent l'ensemble de l'agglomération poitevine avec des délais maîtrisés.",
 ...
 dict(slug='vannes', name='Vannes', dept='Morbihan', code='56', in_dept='dans le Morbihan',
   ...
   local="Nichée au fond du golfe du Morbihan, Vannes séduit par son cadre de vie et connaît une croissance résidentielle marquée, avec un habitat majoritairement pavillonnaire autour de l'agglomération. Le réseau de bornes publiques s'y étend progressivement ; la recharge à domicile demeure toutefois la solution la plus simple et la plus économique pour les maisons de Séné, Arradon, Saint-Avé ou Ploeren. Le réseau d'installateurs certifiés IRVE du Morbihan couvre bien le bassin vannetais, avec des délais d'intervention maîtrisés.",
 ...
 dict(slug='pau', name='Pau', dept='Pyrénées-Atlantiques', code='64', in_dept='dans les Pyrénées-Atlantiques',
   ...
   local="Au piémont des Pyrénées, Pau allie cadre de vie privilégié et dynamisme économique, avec un habitat pavillonnaire très présent dans son agglomération. La collectivité développe son réseau de bornes publiques ; la recharge à domicile reste néanmoins la solution la plus simple et la plus économique pour les maisons de Lons, Billère, Lescar ou Jurançon. Le réseau d'installateurs certifiés IRVE des Pyrénées-Atlantiques est bien implanté et couvre l'ensemble du bassin palois avec des délais courts.",
 ...
 dict(slug='niort', name='Niort', dept='Deux-Sèvres', code='79', in_dept='dans les Deux-Sèvres',
   ...
   local="Reconnue comme un grand pôle mutualiste et de l'assurance, Niort bénéficie d'un tissu économique solide et d'un habitat pavillonnaire largement dominant autour de l'agglomération. Le réseau de bornes publiques s'y développe régulièrement ; la recharge à domicile demeure cependant la solution la plus simple et la plus économique pour les maisons de Chauray, Bessines, Aiffres ou Échiré. Le réseau d'installateurs certifiés IRVE des Deux-Sèvres couvre bien le bassin niortais, avec des délais d'intervention maîtrisés.",
 ...
 dict(slug='clermont-ferrand', name='Clermont-Ferrand', dept='Puy-de-Dôme', code='63', in_dept='dans le Puy-de-Dôme',
   ...
   local="Au cœur de l'Auvergne, Clermont-Ferrand et Clermont Auvergne Métropole voient la mobilité électrique progresser, portées par un tissu économique dynamique et un habitat individuel important dans les communes de la plaine de la Limagne. La métropole déploie son réseau de bornes publiques et encourage le passage à l'électrique, mais la recharge à domicile reste la solution la plus simple et la plus économique pour les pavillons de Chamalières, Aubière ou Cournon-d'Auvergne. Les installateurs certifiés IRVE du Puy-de-Dôme couvrent l'ensemble de la métropole clermontoise, du centre-ville aux communes périphériques, avec des délais maîtrisés.",
 ...
 dict(slug='tours', name='Tours', dept='Indre-et-Loire', code='37', in_dept='en Indre-et-Loire',
   ...
   local="Au cœur du Val de Loire, Tours conjugue patrimoine, dynamisme universitaire et habitat mêlant copropriétés urbaines et pavillonnaire dans toute la métropole tourangelle. Tours Métropole Val de Loire développe son réseau de bornes publiques ; la recharge à domicile reste toutefois la solution la plus simple et la plus économique pour les maisons de Joué-lès-Tours, Saint-Cyr-sur-Loire, Saint-Avertin ou Chambray-lès-Tours. Le réseau d'installateurs certifiés IRVE d'Indre-et-Loire est dense et couvre toute l'agglomération tourangelle avec des délais courts.",
 ...
 dict(slug='metz', name='Metz', dept='Moselle', code='57', in_dept='en Moselle',
   ...
   local="Grande ville du Grand Est, Metz conjugue un riche patrimoine et un dynamisme économique porté par sa position transfrontalière, avec un habitat mêlant copropriétés et pavillonnaire dans toute l'agglomération messine. Le réseau de bornes publiques s'y étend ; la recharge à domicile reste cependant la solution la plus simple et la plus économique pour les maisons de Montigny-lès-Metz, Woippy, Marly ou Le Ban-Saint-Martin. Le réseau d'installateurs certifiés IRVE de la Moselle est bien implanté et couvre l'ensemble du bassin messin avec des délais courts.",
