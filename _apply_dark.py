...
THEME_INIT = '<script>(function(){try{var K="les-eclaires-theme",t=localStorage.getItem(K);if(!t)t=(window.matchMedia&&window.matchMedia("(prefers-color-scheme:dark)").matches)?"dark":"light";document.documentElement.setAttribute("data-theme",t);}catch(e){}})();</script>'
